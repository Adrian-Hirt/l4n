...
Doorkeeper.configure do
  ...
  #
  # Defined scopes for L4N:
  #   * user:lan:read => allows the application to get status informations about an user
  #     connected to a lan party (e.g. wether the user is checked in at a LanParty). This does not
  #     allow the application to read general data of the user.
  #
  optional_scopes(*L4N_OAUTH_SCOPES.keys)
